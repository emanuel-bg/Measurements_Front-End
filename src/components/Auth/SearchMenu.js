      ...
      <div className="container mt-4">
         <div className="row  align-items-center">
            <div className="col-md-3">
               ...
               {<span className="text-danger">{formErrors.attribute}</span>}
            </div>
            <div className="col-md-5">
               <input
                  className="form-control form-control-sm"
                  type={selectedAttribute === "date" ? "datetime-local" : "text"}
               ...
               />
               {<span className="text-danger">{formErrors.searchText}</span>}
            </div>
